...
import { Users, Mail, MessageSquare, Reply, Search } from "lucide-react";
...
export function DashboardCampaignList({ campaigns }: { campaigns: CampaignStat[] }) {
        ...
        {filtered.map((campaign) => (
          ...
          >
            ...
            <div className="flex items-center gap-3 shrink-0 text-xs text-muted-foreground">
              ...
              <span className="flex items-center gap-1" title="Pending Review">
